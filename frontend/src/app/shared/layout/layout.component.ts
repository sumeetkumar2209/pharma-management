...
export class LayoutComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    notificationItems = [];
    sideNavItems = JSON.parse('[{"label":"Dashboard","icon":"dashboard","link":["/dashboard"],"order":0,"subitem":[]},{"label":"Supplier","order":1,"icon":"flare","link":["/supplier"],"subitem":[]},{"label":"Customer","order":1,"icon":"phonelink","link":["/customer"],"subitem":[]},{"label":"Transport","order":2,"icon":"local_shipping","link":["/transport"],"subitem":[]},{"label":"Product","icon":"view_module","order":3,"link":["/product/add"],"subitem":[]},{"label":"Purchase Orders","order":4,"link":["/purchase"],"icon":"account_balance_wallet","subitem":[]},{"label":"Warehouse","order":5,"icon":"home","link":["/warehouse"],"subitem":[]},{"label":"Customer Orders","order":6,"icon":"shopping_cart","link":["/orders"],"subitem":[]},{"label":"Goods Returned","order":4,"icon":"compare_arrows","link":["/goods"],"subitem":[]},{"label":"Reports","order":3,"icon":"next_week","link":["/reports"],"subitem":[]},{"label":"Audit Trail","order":3,"icon":"account_balance","link":["/audit"],"subitem":[]}]'
